  ...
  return (
    ...
    >
      <div data-tauri-drag-region className="flex items-center gap-2.5 px-4 pointer-events-none">
        <div className="w-5 h-5 rounded-md bg-gradient-to-br from-accent to-accent-deep flex items-center justify-center shadow-[0_0_12px_rgba(124,192,244,.5)]">
          <Flame size={12} strokeWidth={2.6} className="text-on-accent" />
        </div>
